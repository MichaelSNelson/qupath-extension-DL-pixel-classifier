...
rem Check if ENV_PATH looks like a directory path (contains \ or /)
rem If so, use --prefix. Otherwise, use --name.
set "CONDA_USE_PREFIX=0"
echo %ENV_PATH% | findstr /r "[:\\/]" >nul 2>&1
